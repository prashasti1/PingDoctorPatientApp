package com.cureu.Doctor.Notification.service;
...
import com.cureu.Doctor.Notification.app.Config;
import com.cureu.Doctor.Notification.util.NotificationUtils;
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                ...
                Intent resultIntent = new Intent(getApplicationContext(), DashboardMainNew.class);
